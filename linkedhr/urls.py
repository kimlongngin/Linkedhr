...
urlpatterns = [
	...
	url(r'^userprofile/recruit_home/$', views.RecruitmentHomeView.as_view(), name='recruitment-home'),
	
	# /linkedhr/userprofile/recruitment_post
	url(r'^userprofile/recruit_post/$', views.RecruitmentPostView.as_view(), name='recruitment-post'),
